...
public class AdminLoginSuccess extends javax.swing.JFrame{
    ...
    public AdminLoginSuccess() throws SQLException, ClassNotFoundException {
        initComponents();
        employee = new Employee(33, "ottawa canadaw 28 ", 613878179, "aeakai@yahoo.com", true);
...
private void renewMembershipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_renewMembershipActionPerformed
    // DONE!
    String s = new BarcodeScannerInterface().scanMembershipCard(this);
    renew = new RenewMembershipPayment(this.employee, s);
  
    this.setVisible(false);
    renew.main(new String[2]);

}//GEN-LAST:event_renewMembershipActionPerformed

private void rentItemActionPerformed(java.awt.event.ActionEvent evt) {
...
private void suspensionActionPerformed(java.awt.event.ActionEvent evt) {
