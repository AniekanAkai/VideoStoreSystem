...
private void purchaseActionPerformed(java.awt.event.ActionEvent evt){
        try {
            ...
            System.err.println("There was an SQL exception, from error in 'purchasePay.main(null)' ");
        }

}//GEN-LAST:event_purchaseActionPerformed

private void editAccountInfoActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    try {
            ...
            Logger.getLogger(LoginSuccessful.class.getName()).log(Level.SEVERE, null, ex);
            System.err.println("ClassNotFoundException from line 196");
        } catch (SQLException ex) {
            Logger.getLogger(LoginSuccessful.class.getName()).log(Level.SEVERE, null, ex);
            System.err.println();
        }
...
private void rentItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rentItemActionPerformed
   ...
   try{ 
    ...
    rent.setVisible(true);
       ...
       e.printStackTrace();
       System.err.println("Error with line 221");
   }
}
...
// TODO add your handling code here:
    ...
    reserve = new MakeReservation(this.employee, member);
    this.setVisible(false);
...
private void cancelReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelReservationActionPerformed
    ...
    */
    ...
    String queryMember = "SELECT MemberID, FirstName, LastName, email, PhoneNumber, reservations"
            + " FROM members WHERE id = " + Integer.parseInt(s);
