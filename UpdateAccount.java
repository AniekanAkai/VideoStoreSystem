...
public class UpdateAccount extends javax.swing.JFrame {
    ...
    UpdateAccount(Employee employee) throws ClassNotFoundException, SQLException {
        ...
        id = bcscanner.scanMembershipCard(this);
...
private static void showMemberInformation() throws SQLException, ClassNotFoundException{
        memberID.setText(id);
        
        new Utility().connect();  
         
        rs = new Utility().stmt.executeQuery("SELECT * FROM members WHERE MemberID = " + id);
         ...
         member = new MemberAccount(Integer.parseInt(id), memberFirstName.getText(), memberLastName.getText(),
...
// TODO add your handling code here:
    ...
    private static javax.swing.JTextField memberCity;
    private static javax.swing.JTextField memberFirstName;
    private static javax.swing.JLabel memberID;
    private static javax.swing.JTextField memberLastName;
    private static javax.swing.JComboBox memberProvince;
    private static javax.swing.JTextField newAddress;
