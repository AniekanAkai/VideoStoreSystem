...
private void employeePasswordFieldActionPerformed(java.awt.event.ActionEvent evt) {}
...
private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {
    try {
            ...
            while (rsID.next()) {
                ...
                System.out.println(password);//Test to visually see if the right "password" was fetched

                if(password.equals(new String(employeePasswordField.getPassword()))){
                    employee = new Employee(Integer.parseInt(employeeIdField.getText()), 
                            new String(employeePasswordField.getPassword()));
                    ...
                    while(rsAdmin.next()){
                        ...
                        System.out.println(admin);//Test to visually see if the right value was fetched
                    }
                    if(admin.equals( "y")){
            ...
            System.err.println("SQL code error.");
            ex.printStackTrace();
