...
public class RentItemMemberInfo extends javax.swing.JFrame {
    ...
    //this is stored so as to be able to pass it into the next  window frame
    private static Item[] items = new Item [50];
    
    //only the titles of the items are needed in this window frame
    private static String[] scannedItemsTitle = new String[50];
    ...
    public static void addItemsToList(){
        ...
        do{
            id = new BarcodeScannerInterface().scanItem(frame);
...
public static void main(String args[]) {
        ...
        String s = new BarcodeScannerInterface().scanMembershipCard(frame);
        try {
            memberID.setText(s);
